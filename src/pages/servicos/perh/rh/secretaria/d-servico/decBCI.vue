      ...
      <div id="elemento-para-pdf" class="StyleFontDocument c">
        ...
        <div class="row">
          ...
          <div class="col-12 alignTextJustify" style="line-height: 1.5">
            ...
            <span class="tab">
              Para efeitos de obtenção de
              {{ addInfo.efeito_da_declaracao }} (BCI), a Direcção Municipal de
            ...
            >, auferindo o salário líquido mensal de
            ...
            <br />
            <span class="tab"
              >Esta Direcção Municipal compromete-se, proceder a
              transferência</span
            >
            mensal dos seus salários para a conta nº
            <b>{{ dados[0].num_conta_bancaria }}</b> junto do vosso Banco.
            <br />
            <br />
            <span class="tab"
              >Este compromisso apenas será revogado com o consentimento prévio
              do BCI</span
            >
            manifestando por escrito. Se antes disso, o trabalhador deixar de
            pertencer aos nossos quadros, ocorrência que, desde já, nos
            comprometemos a comunicar com a devida antecedência.
            <br />
            <br />
            <span class="tab">
              OBS.: Esta Declaração destina-se para efeito de:
              <b>{{ addInfo.efeito_da_declaracao }} no Banco BCI.</b>
            </span>
            <br />
            <br />
            <span class="tab"
              >Por ser verdade e me ter sido solicitado, emitimos a presente
              Declaração</span
            >
            que assinamos e autenticamos com o carimbo a óleo em uso nesta
            Direcção Municipal.
            <br />
          </div>
