      ...
      <div id="elemento-para-pdf" class="StyleFontDocument c">
        ...
        <div class="row">
          <div class="col-12 tab">
            <br />
            <br />
            <b style="font-family: Broadway"
              >DECLARAÇÃO DE SERVIÇO Nº ____/{{ dateNowYear }}</b
            >
          </div>
          ...
          <div class="col-12 alignTextJustify" style="line-height: 1.5">
            ...
            <span class="tab">
              Para efeitos de obtenção de Crédito, a Direcção Municipal de
              Educação {{ artigoMunicipio }} {{ dados[0].municipio }},
            </span>
            ...
            >, vinculado ao contrato de trabalho por tempo indeterminado, desde
            {{ dataInicioFuncao }}, auferindo um rendimento mensal líquido de
            <b>{{ formatCurrency(dados[0].salario_liquido) }}</b> ({{
              dados[0].salario_liquido_extenso
            }}), na conta nº <b>{{ dados[0].num_conta_bancaria }}</b
            >.

            <br />
            <br />
            <span class="tab">
              Compromete-se também a nossa instituição a manter o salário
              domiciliado do
            </span>
            colaborador junto à vossa instituição, e na eventualidade de
            qualquer alteração relevante da relação jurídico-contratual com o
            funcionário, informar ao Banco com um período de antecedência mínimo
            de 15 dias, de modo a mitigar o risco de incumprimento de
            responsabilidades junto à vossa instituição.
            <br />
            <br />
            <span class="tab"
              >E para que não lhe ponham qualquer impedimento, mandei passar a
              presente
            </span>
            Declaração que vai por mim devidamente assinada e autenticada com o
            carimbo a óleo em uso nesta Instituição.
            <br />
          </div>
