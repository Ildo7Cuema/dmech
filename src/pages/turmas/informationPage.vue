  ...
  <q-dialog v-model="showInfor" persistent>
    <q-card>
      ...
      <q-card-section class="row q-col-gutter-sm">
        <p><b>Turma: </b>{{ showInformation.nome_turma }}</p>
        <p><b>Nº de sala: </b>{{ showInformation.num_sala }}</p>
        <p>
          <b>Pertence ao curso de: </b>{{ showInformation.curso.nome_curso }}
        </p>
        <p><b>Ano lectivo: </b>{{ showInformation.ano }}</p>
