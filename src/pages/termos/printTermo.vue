      ...
      <div style="display: none">
        <div id="elemento-para-pdf" class="StyleFontDocument alignTextJustify">
          ...
          <div class="row">
            <div class="col-12 text-center">
              <br />
              <b class="text-red-9">TERMO DE FREQUÊNCIA Nº ______/20___</b>
            </div>
          </div>
          ...
          <table style="width: 100%; border-collapse: collapse">
            <tr>
              ...
              <td
                ...
                "
              >
                <b class="text-indigo">{{ alunoData.nome }}</b>
              </td>
            </tr>
            <tr>
              <td
          ...
          >
            ...
            <template v-slot:header>
              <q-tr>
                ...
                <q-th style="width: 47%; font-size: 10px">Disciplinas</q-th>
                <q-th
    ...
    watch(
      ...
      async (newValue) => {
        ...
        try {
          ...
          console.log(data[0].alunos);
          alunoData.value = data[0].alunos;
          ...
          data.forEach(
            ({
              ...
              const key = disciplinas.nome_disciplina;
              ...
              if (
                (["Língua Portuguesa", "Inglês", "Francês"].includes(
                  ...
                  classe.value == "6ª Classe") ||
                classe.value == "9ª Classe" ||
                classe.value == "12ª Classe" ||
                classe.value == "13ª Classe"
              ) {
                pauta[key][`${trimestreName}_MAC`] = mac;
                pauta[key][`${trimestreName}_NPP`] = npp;
                pauta[key][`${trimestreName}_MFD`] = mfd;
                pauta[key][`${trimestreName}_NEO`] = neo;
                pauta[key][`${trimestreName}_NEE`] = nee;
                pauta[key][`${trimestreName}_MEC`] = mec;
                pauta[key][`${trimestreName}_MF`] = mf;
              } else if (
                (data[0].trimestre == "III Trimestre" &&
                ...
                pauta[key][`${trimestreName}_MAC`] = mac;
                pauta[key][`${trimestreName}_NPP`] = npp;
                pauta[key][`${trimestreName}_NFD`] = mfd;
                pauta[key][`${trimestreName}_NE`] = ne;
                pauta[key][`${trimestreName}_MF`] = mf;
              } else {
                pauta[key][`${trimestreName}_MAC`] = mac;
                pauta[key][`${trimestreName}_NPP`] = npp;
                pauta[key][`${trimestreName}_NPT`] = npt;
                pauta[key][`${trimestreName}_MT`] = mt;
              }

              disciplines.add(trimestreName);
            }
          );
